...
from polkadotetl.constants import POLKADOT_TREASURY, DECIMAL_BEFORE_REDENOMINATION, DECIMAL_AFTER_REDENOMINATION, REDENOMINATION_BLOCK
    ...
    for extrinsic in extrinsics:
        ...
        for event in events:
            ...
            if event_type == "balances.Transfer":
                ...
                if int(block_number) >= REDENOMINATION_BLOCK:
            ...
            txn = dict(
                ...
                coin_value=coin_value if status else 0,
                fee=fee,
